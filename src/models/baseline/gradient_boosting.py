...
Purpose:
- Reduce bias via sequential tree learning
- Capture complex non-linear relationships
- Serve as a strong pre-XGBoost baseline
...
def train_gradient_boosting_regressor(
    ...
    """
    Train and evaluate a Gradient Boosting regression baseline model.
    ...
    with mlflow.start_run(run_name="Gradient_Boosting"):
        ...
        mlflow.log_artifacts(
            artifact_dir,
            artifact_path="baseline/gradient_boosting"
        )
